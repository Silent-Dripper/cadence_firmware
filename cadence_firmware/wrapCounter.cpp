...
/**
 * @brief Manually change the current value of the counter. No protections around setting it to too large/small of a value.
 * 
...
/**
 * @brief Set the "wrap" point, where after this value the counter's value will be zero.
 * 
...
/**
 * @brief Increment the counter to the next position. If we're over the number of values for the counter, wrap back to zero.
 * Return true if a wrap occurs, false otherwise.
 * 
 * @return boolean 
 */
...
/**
 * @brief Opposite of increment, decrease the current count. If we decrement at zero, wrap back to the max value.
 * If this wrap occurs, return true.
 * 
 * @return boolean 
 */
